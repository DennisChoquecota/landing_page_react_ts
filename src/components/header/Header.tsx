...
function Header (){
    return(
      <>
      <div className={`text-white md:block hidden py-[11px] px-[50px] ${HEADER.bg === "" ? "bg-primary": HEADER.bg}`} id="inicio">
              ...
              <div className="float-left">
                <ul className="flex gap-1.5">
                  <li className="mr-3.75 inline-block">
                    ...
                    <a href={`${HEADER.cellphone}`}>{HEADER.cellphone}</a>
                  </li>
                  <li className="mr-3.75 inline-block">
                ...
                <ul className="flex">
                  {
                    HEADER.items.map((content, index) => (
                      <SocialHeader key={index} ref={content.socialRef} icon={content.socialIcon} />
                    ))
                  }
                </ul>
              </div>
